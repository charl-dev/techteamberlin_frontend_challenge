...
const api_uri = "https://api.spacexdata.com/v3/launches?launch_year=2018&order=desc&limit=20"
        ...
        <div className="row justify-content-md-center">
          <div className="col-8 shadow rounded" style={{marginTop:64, marginBottom:64}}>
            <h4 style={{marginTop:20}}>
              <img src={require('./logo.png')} className="responsive-img" alt="SpaceX Logo"  width={150}/>
            ...
            <ToolkitProvider
              ...
              {(props) => (
                <div>
                  <div className="row">
                    <div className="col-2"><p className="lead">Search:</p></div>
                    <div className="col-10">
                      <SearchBar { ...props.searchProps } placeholder="Search Mission Name" />
                    </div>
                  </div>
                  <hr />
                  <BootstrapTable 
                    ...
                    bordered={ false }
                    condensed
                    noDataIndication="No launches found" />
                </div>
              )}
